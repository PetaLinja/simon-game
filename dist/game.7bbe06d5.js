...
$(".btn").click(function () {
  ...
  checkAnswer(userClickedPattern.length - 1); //console.log(userClickedPattern);
});
...
function nextSequence() {
  ...
  gamePattern.push(randomChosenColor); // $("#" + randomChosenColor).read(() => {
  //     $("#" + randomChosenColor).fadeOut();
  //     $("#" + randomChosenColor).fadeIn();
  // });

  $("#" + randomChosenColor).fadeIn(100).fadeOut(100).fadeIn(100);
  playSound(randomChosenColor); //animatePress(randomChosenColor);
}
